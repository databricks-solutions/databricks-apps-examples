...
def render_stock_optimization_page() -> html.Div:
    ...
    return html.Div([
        ...
        dmc.Space(h=10),
        dmc.Text(
            "View stock optimization results for your forecast runs. Our EOQ-based model calculates optimal order quantities, safety stock levels, and reorder points to maximize profitability across all Coles product categories.",
            size="md",
            c="dimmed"
        ),
        dmc.Space(h=20),
