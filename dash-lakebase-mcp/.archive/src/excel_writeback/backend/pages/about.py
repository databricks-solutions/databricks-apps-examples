        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        dmc.Title(
                            "About Coles Inventory Intelligence",
                            order=1,
                            ta="center",
                            mb=16,
                            c="#E21837",
                        ...
                        html.Div(
                            [
                                ...
                                dmc.Text(
                                    [
                                        "Coles Inventory Intelligence is a purpose-built forecasting and stock optimization platform designed for Coles Group's retail operations. ",
