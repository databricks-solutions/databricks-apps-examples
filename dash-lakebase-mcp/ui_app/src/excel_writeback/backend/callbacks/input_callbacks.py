...
def upload_data_to_uc(
...
) -> Tuple[bool, List[dmc.Alert], bool, Optional[str], Dict, str, str]:
    log(
    ...
    if has_critical_errors:
        ...
        return True, alerts, False, None, hidden_style, "", "/stock-optimization"
    ...
    if n_clicks:
        ...
        results_href = f"/stock-optimization?forecast={forecast_id}"
        return True, [success_alert], False, forecast_id, visible_style, f"Forecast ID: {forecast_id}", results_href
    
    return False, alerts, False, None, hidden_style, "", "/stock-optimization"
